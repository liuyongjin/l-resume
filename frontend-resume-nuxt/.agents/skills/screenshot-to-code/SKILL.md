...
| Pages | `frontend-resume-nuxt/src/pages/` |
| Components | `frontend-resume-nuxt/src/components/` |
| Utils | `@/lib/utils` (`cn()` helper) |

Read `frontend-resume-nuxt/.agents/skills/shadcn-vue/SKILL.md` when adding or wiring UI components.
...
- Place pages in `frontend-resume-nuxt/src/pages/`; reusable blocks in `frontend-resume-nuxt/src/components/`
...
3. **Usage instructions** (how to run: `npm run dev` in `frontend-resume-nuxt/`)
...
- **Reuse**: Prefer shadcn-vue components already in `frontend-resume-nuxt/src/components/ui/`
